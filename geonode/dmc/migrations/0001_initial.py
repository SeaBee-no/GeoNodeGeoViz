# Generated by Django 3.2.16 on 2023-04-17 08:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mosaiced_image', models.FileField(blank=True, null=True, storage=django_minio_backend.models.MinioBackend(bucket_name='geoviz-upload-data'), upload_to=functools.partial(geonode.dmc.models.get_upload_path, *(), **{'folder': 'orthomosaic'}), verbose_name='Upload single mosaiced file')),
                ('row_image', models.FileField(blank=True, null=True, storage=django_minio_backend.models.MinioBackend(bucket_name='geoviz-upload-data'), upload_to=functools.partial(geonode.dmc.models.get_upload_path, *(), **{'folder': 'raw_images'}), verbose_name='Upload raw images a single .zip file')),
                ('ground_control_point', models.FileField(blank=True, null=True, storage=django_minio_backend.models.MinioBackend(bucket_name='geoviz-upload-data'), upload_to=functools.partial(geonode.dmc.models.get_upload_path, *(), **{'folder': 'gcp'}), verbose_name='Upload ground control point as .csv')),
                ('ground_truth_point', models.FileField(blank=True, null=True, storage=django_minio_backend.models.MinioBackend(bucket_name='geoviz-upload-data'), upload_to=functools.partial(geonode.dmc.models.get_upload_path, *(), **{'folder': 'ground_truth'}), verbose_name='Upload ground truth point as .csv')),
                ('dronePath', models.FileField(blank=True, null=True, storage=django_minio_backend.models.MinioBackend(bucket_name='geoviz-upload-data'), upload_to=functools.partial(geonode.dmc.models.get_upload_path, *(), **{'folder': 'drone_path'}), verbose_name='Upload drone path file as .kml')),
                ('other', models.FileField(blank=True, null=True, storage=django_minio_backend.models.MinioBackend(bucket_name='geoviz-upload-data'), upload_to=functools.partial(geonode.dmc.models.get_upload_path, *(), **{'folder': 'other'}), verbose_name='Upload any supporting data such pdf, report, photo in a zip format etc')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other', models.TextField(blank=True, max_length=100, null=True, verbose_name='Upload any supporting data such pdf, report, photo in a zip format etc')),
